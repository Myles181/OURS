...
// Function to calculate the angle for each segmentQ  
  ...
  <div className="fixed inset-0 bg-black z-30 flex flex-col">
    ...
    <nav className="flex-1 flex flex-col px-4 py-8 space-y-6 overflow-y-auto">
      ...
      {navItems.map((item) => (
        <a 
          key={item.name}
          href={item.href} 
          className={`text-center py-2 ${navItems === item.name ? 'text-yellow-500' : 'text-white'}`}
          onClick={() => {
    ...
    <div className="p-4">
      ...
      <main className="flex-1 flex flex-col items-center px-4 pb-16 pt-[4rem]">
        {/* Status Bar */}
        <div className="w-full text-xs text-gray-400 mb-6 text-center">
        ...
        <div className="animate-spin-slow w-72 h-72 rounded-full mb-8 flex items-center justify-center">
          ...
          <div class="absolute inset-0 z-0 rounded-full blur-2xl bg-yellow-300 opacity-40 scale-105"></div>
        </div>
        ...
        <footer className="w-full max-w-md mt-16 flex flex-col items-center">
          ...
          <div className="grid grid-cols-2 gap-x-12 gap-y-4 text-center mb-8">
            <a href="#home" className="text-gray-400 hover:text-yellow-500">Home</a>
            <a href="#tokenomics" className="text-gray-400 hover:text-yellow-500">Tokenomics</a>
            <a href="#reflections" className="text-gray-400 hover:text-yellow-500">Reflections</a>
            <a href="#community" className="text-gray-400 hover:text-yellow-500">Community</a>
            <a href="#roadmap" className="text-gray-400 hover:text-yellow-500">Roadmap</a>
          </div>
          
          {/* Whitepaper button */}
          <a href="#whitepaper" className="text-yellow-500 font-semibold mb-12">Whitepaper</a>
